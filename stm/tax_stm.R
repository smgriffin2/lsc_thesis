...
labels = c("Health and Air Quality", "BusinessIncentives", "FutureGenerations", "Science/Technology", "Protect Econ/Future", "Energy Independance", "Job Creation", "Threat", "Fiscal Responsability", "Technology Development")
typeof(labels)
...
## Plot graph
tax_prob_plot <- ggplot(df, aes(x = Labels, y = Probability, size = )) + 
